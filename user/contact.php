...
<html>
     ...
     <body>
		 ...
		 <div class="col-sm-4">
		 <label>Name</label>
		 <input type="text" class="form-control" name="cname" maxlength="20" required/>
		 </div>
		 <div class="col-sm-4">
		 <label>Email</label>
		 <input type="text" class="form-control" name="cemail" maxlength="15" required/>
		 </div>
		 <div class="col-sm-4">
		 <label>Mobile</label>
		 ...
		 <br/>
		 <label>Message</label>
		 <textarea class="form-control" name="cmsg" maxlength="30" required></textarea>
		 </div>
		 </div class="col-sm-12">
