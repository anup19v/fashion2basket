 <section id="main">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="images/b.jpeg" style="height:350px;width:100%;" alt="...">
      <div class="carousel-caption">
        <i style="font-size:80px;color:red;">Get 50% Off</i>
      </div>
    </div>
    <div class="item">
      <img src="images/e.jpeg" style="height:350px;width:100%;" alt="...">
      <div class="carousel-caption">
          <i style="font-size:80px;color:red;">Buy 1 Get 1 Free</i>
      </div>
    </div>
	<div class="item">
      <img src="images/c.jpg" style="height:350px;width:100%;" alt="...">
      <div class="carousel-caption">
